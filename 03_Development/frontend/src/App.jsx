...
const ViewPatientMedicalHistory = lazy(() => import("./pages/Patient/ViewPatientMedicalHistory.jsx")) 
...
const InitialSalaryConfig = lazy(() => import("./pages/Salary/InitialSalaryConfig.jsx")) 
const DoctorProfile = lazy(() => import("./pages/doctors/DoctorProfile.jsx"))
const EditDoctorProfile = lazy(() => import("./pages/doctors/EditDoctorProfile.jsx"))
